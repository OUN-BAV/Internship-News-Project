...
return [
    ...
    */
    ...
    'styles' => [
        // has primary color electric purple (backpack default)
        'packages/backpack/base/css/bundle.css',
        'packages/backpack/base/css/lightbox.css',
        'packages/backpack/base/css/container.css',
    ...
    'sidebar_class' => 'sidebar sidebar-pills bg-light shadow-sm',
